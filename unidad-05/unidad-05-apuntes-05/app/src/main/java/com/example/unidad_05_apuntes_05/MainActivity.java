...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datos.add(new Datos(R.drawable.gatito1, "Línea superior 1", "Línea inferior 1"));
        datos.add(new Datos(R.drawable.gatito1,"Línea superior 2", "Línea inferior 2"));
        datos.add(new Datos(R.drawable.gatito1,"Línea superior 3", "Línea inferior 3"));
